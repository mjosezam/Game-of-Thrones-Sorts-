...
public class Assets {
	...
	/**
	 * Crea las listas de imagenes para el manejo de sprites Se recortan las
	 * imagenes y se asignan a la lista
	 */
	public static void init() {
		...
		SpriteSheet hoja = new SpriteSheet(ImageLoader.cargarImagen("/texturas/spritesDragon.png"));// sprites del
																									// jugador volando
