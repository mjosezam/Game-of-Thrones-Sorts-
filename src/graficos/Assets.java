...
public class Assets {
    ...
    public static void init() {//sirve para cargar todos los efectos 1 sola vez
        ...
        SpriteSheet hoja = new SpriteSheet(ImageLoader.cargarImagen("resource/texturas/spritesDragon.png"));//sprites del jugador volando
        SpriteSheet hoja2 = new SpriteSheet(ImageLoader.cargarImagen("resource/texturas/dragon1.png"));//sprites del dragon 1
        SpriteSheet hoja3 = new SpriteSheet(ImageLoader.cargarImagen("resource/texturas/dragon2.png"));//sprites del dragon 2
        SpriteSheet hoja4 = new SpriteSheet(ImageLoader.cargarImagen("resource/texturas/dragon3.png"));//sprites del dragon 3


        cielo = ImageLoader.cargarImagen("resource/texturas/cielo.png");
        Hud = ImageLoader.cargarImagen("resource/texturas/Hud.png");
        heart = ImageLoader.cargarImagen("resource/texturas/heart.png");
        fireball = ImageLoader.cargarImagen("resource/texturas/Fireball.png");
        gameOver = ImageLoader.cargarImagen("resource/texturas/gameOver.png");
        menu = ImageLoader.cargarImagen("resource/texturas/menu.png");
        puntaje = ImageLoader.cargarImagen("resource/texturas/puntaje.png");
        /*
