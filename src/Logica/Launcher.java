...
public class Launcher {
    ...
    private final static Logger LOG_SUBNIVEL = Logger.getLogger("bitacora.bitacora.subnivel");
    private final static Logger LOG_UNDER = Logger.getLogger("bitacora.bitacora.subnivel.under");
