...
public class Jugador extends Creature {
	...
	public Jugador(Game juego, float x, float y, ControlDisparo cd) {
		...
		this.velocidad = 5;
		this.controlDisp = cd;
		this.hitbox = new Rectangle((int) getX(), (int) getY(), getAncho(), getAlto());// hitbox del jugador segun su
																						// posicion
	}
	...
	/**
	 * Cambia los valores de (x,y) del jugador y dispara de acuerdo a los controles
	 * pulsados.
	 */
