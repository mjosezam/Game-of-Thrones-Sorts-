...
public class Proyectil extends Entidad {
	 ...
	 */
	public Proyectil(Game game, float x, float y, boolean jugador) { // Si jugador es true es disparo del jugador, si no
																		// es del enemigo
		super(game, x, y);
		this.hitbox = new Rectangle((int) getX(), (int) getY(), getAncho() - 70, getAlto() - 80);// establece el hitbox
																									// del proyectil
